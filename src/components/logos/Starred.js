...
class Starred extends React.Component {
	...
	render() {
		return <svg className="star" onClick={this.props.onClick} width="22px" height="44px" viewBox="0 0 22 44" version="1.1" xmlns="http://www.w3.org/2000/svg" 

		style={{fill:"#d74e48", fillRule: "evenodd", clipRule: "evenodd", strokeLinejoin: "round", strokeMiterlimit: 1.41421}}> 
