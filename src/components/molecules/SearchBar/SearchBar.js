...
const SearchBar = ({onInputChange, ...props}) => (
	<div className={`search__div full-height full-width d-flex justify-content-center align-items-center`} {...props}>
		...
		<div className={"d-flex align-items-center justify-content-center pr-2"}>
			<Symbol symbolType={"searchSymbol"} style={{fill: 'white'}}/>
		</div>
	</div>
);
